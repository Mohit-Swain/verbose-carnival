        ...
        <div className=" flex-grow w-56 relative">
            <div className="w-full h-full bg-myviolet cursor-pointer hover:shadow-xl  box-content">
                <svg xmlns="http://www.w3.org/2000/svg"  
                        className="h-full w-full z-30  absolute top-0 md:top-5 transform hover:scale-110
                          text-gray-100 active:text-green-500" 
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path  strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <svg viewBox="0 0 200 200"  className="z-20 absolute hidden md:block top-0 transform hover:scale-105" xmlns="http://www.w3.org/2000/svg">
