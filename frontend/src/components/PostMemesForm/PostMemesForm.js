...
function PostMemesForm(props){
    ...
    return (
        <section className="md:flex-divide h-2/3 md:h-full w-full bg-blue-100 overflow-auto md:overflow-hidden">
            <DropZone onDrop={onDrop} noClick>
                {({getRootProps,getInputProps}) => (
                    <div {...getRootProps()} className="md:my-4 mx-16 md:px-16 py-2 md:py-2 md:border-2 md:border-purple-400 
                            md:rounded-md md:border-dashed ">
